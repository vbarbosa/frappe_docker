...
echo ">> Subindo o frontend do ERP com bind em ${TS_IP}:8080 ..."

# 2. Subir o frontend (o compose lê ${TS_IP} do ambiente)
TS_IP="${TS_IP}" docker compose -f pwd.yml up -d frontend
